...
namespace BibliotecaBd.Controllers
{
    public class EditorialsController : Controller
    {
        ...
        public EditorialsController(BibliotecaBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Ideditorial,Editorial1,Nombrecontacto,Direccion,Ciudad,Telefono,Email,Comentario,Activo")] Editorial editorial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Ideditorial,Editorial1,Nombrecontacto,Direccion,Ciudad,Telefono,Email,Comentario,Activo")] Editorial editorial)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaBdContext.Editorials'  is null.");
            }
            var editorial = await _context.Editorials.FindAsync(id);
            if (editorial != null)
            {
